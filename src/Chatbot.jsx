...
const Chatbot = () => {
    ...
    useEffect(() => {
        // const imgMessage = {
        //     type: "image",
        //     // content: `![image](data:image/png;base64, iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDIBKE0DHxgljNBAAO9TXL0Y4OHwAAAABJRU5ErkJggg==)`
        //     content: `![Cute cat](data:image/png;base64, iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDIBKE0DHxgljNBAAO9TXL0Y4OHwAAAABJRU5ErkJggg==)`
        //     // content: `![image](data:image/png;base64,==)`
        //     // content: '![image](https://www.researchgate.net/publication/350797180/figure/fig1/AS:1094072307585024@1637858573299/Graphical-representation-of-the-inventory-level-over-time.jpg)'
        // };
        ...
        // const jsonResponse = JSON.parse(JSON.stringify(imgMessage));

        // console.log("jsonResponse: ", JSON.stringify(jsonResponse, null, 2));

        // setMessages(prevMessages => [...prevMessages, { sender: 'bot', ...imgMessage }]);
                ...
                <nav className="size-full flex flex-col">
                    <div className="flex items-center justify-between pt-4 pe-4 ps-7">
                        {/* <a className="flex-none focus:outline-none focus:opacity-80" href="#" aria-label="Preline"> */}
                            ...
                            <h1 className="text-xl font-bold">AskBi</h1>
                        {/* </a> */}
                    </div>
                    ...
                    {loading ? (
                        <div className="flex h-96 justify-center items-center">
                            <div className="flex flex-col justify-center items-center space-y-2">
                                <ClipLoader color="#2563eb" loading={loading} />
                            ...
                            <li className="py-2 sm:py-4">
                                <div className="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
                                    <div className="max-w-4xl flex gap-x-2 sm:gap-x-4">
                                        ...
                                        <div className="grow space-y-3 rounded-lg bg-gray-200 px-4 py-2">
                                ...
                                <li key={index} className="py-2 sm:py-4">
                                    <div className="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
                                        <div className="max-w-4xl flex gap-x-2 sm:gap-x-4">
                                            ...
                                            <div className={`grow space-y-2 px-4 py-2 rounded-lg ${message.sender === 'bot' ? "bg-gray-200" : "bg-blue-100"}`}>
                        ...
                        <div className="flex justify-center gap-3 mb-2 sm:mb-3">
                            <>
                                <button
                                    ...
                                    type="button"
                                    className="p-2 inline-flex items-center gap-x-2 text-xs font-medium rounded-lg border-1 border-gray-500 bg-blue-100 hover:shadow-md transition-all duration-300 disabled:opacity-50 disabled:pointer-events-none"
                                >
                                    <span>
                        ...
                        <div className="absolute bottom-px inset-x-px p-2 rounded-b-lg bg-gray-100">
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center gap-x-1">
                                    ...
                                    <button onClick={handleSendMessage} className="inline-flex shrink-0 justify-center items-center size-8 rounded-lg text-white bg-blue-600 hover:bg-blue-500 focus:z-10 focus:outline-none focus:bg-blue-500">
